...
> 한이음 드림업 프로젝트 (2025년 4월 ~ 11월) <br>
- 강화학습 및 이미지 분류 기반의 스마트 분리수거 시스템 설계 <br>
- 사용자 행동 예측을 통한 피드백 시스템 적용 <br><br>

### 💼 미래 내일 일경험 프로그램 <br><br>

> 2025년 6~8월 예정 <br>  
- 실제 기업 현장에서 소프트웨어 기획 및 협업 경험 예정 <br><br>

### 📊 데이터 분석 기반 개인 프로젝트 <br><br>

> 2025년 진행 예정 <br>  
- 관심 분야 데이터를 수집·분석하여 인사이트 도출 <br> 
- Pandas, Matplotlib, scikit-learn 등을 활용한 실습 중심 프로젝트 구상 중 <br>
...
📫 **Contact**  <br/>
📫 이메일: pwh1011@naver.com<br/>
🌐 깃허브: [jini-c](https://github.com/jini-c)<br/><br/>
